        ...
        <div class="auth-box" style="width: 40%; height: auto; padding: 20px">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="signin-occ" class="control-label">Occupation</label>
                            <input type="text" name="occupation" class="form-control" id="signin-occ" placeholder="Enter Occupation" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
